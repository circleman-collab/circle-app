  ...
  if(selectedChat){
    ...
    return(<div style={outerShell}><div style={phoneCard}>
      ...
      <div style={{padding:"12px 18px",borderTop:"1.5px solid "+INK,display:"flex",gap:10,alignItems:"center"}}>
        <input value={msgInput} onChange={e=>setMsgInput(e.target.value)} onKeyDown={e=>{if(e.key==="Enter")sendMsg();}} placeholder="Write something..." style={{flex:1,background:"none",border:"none",borderBottom:"1.5px solid "+INK,outline:"none",fontFamily:font,fontSize:16,color:INK,padding:"6px 0"}}/>
